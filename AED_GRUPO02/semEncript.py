...
import AED_GRUPO02.funcoes.usersFunctions as usersFunctions
import AED_GRUPO02.funcoes.notifications as notifications
import AED_GRUPO02.funcoes.gamesFunctions as gamesFunctions
import AED_GRUPO02.funcoes.commentsFunctions as commentsFunctions
...
def loginUI():
    ...
    loginBtn = ctk.CTkButton(button_frame, text="LOGIN", fg_color="#FFA500", hover_color="#FF5900", width=140, height=37, 
                                border_color="#2E2B2B", text_color="black", font=ctk.CTkFont(size=20, weight="bold"), command=lambda:usersFunctions.userLogin(username_entry.get(), password_entry.get()))
...
def signinUI():
    ...
    signinBtn = ctk.CTkButton(button_frame, text="SIGN IN", fg_color="#FFA500", hover_color="#FF5900", width=140, height=37, 
                                border_color="#2E2B2B", text_color="black", font=ctk.CTkFont(size=20, weight="bold"), command=lambda: usersFunctions.signinFunction(username_entry, email_entry, password_entry))
    signinBtn.pack(side="left", padx=5, anchor="center")
...
def addGameUI():
    ...
    addGameBtn = ctk.CTkButton(app, text="ADD GAME", fg_color="#FFA500", hover_color="#FF5900", width=160, height=37,
                                border_color="black", text_color="black", font=ctk.CTkFont(size=20, weight="bold"), command=lambda: gamesFunctions.addGame(addGameName_entry.get(), genre_entry.get()),)
